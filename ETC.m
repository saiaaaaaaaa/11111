...
figure()
 subplot(2,1,1)
 plot(time,func_x_i1_j2,'b-',time,fun_k_c_1,'r--',time,fun_fu_k_c_1,'k--','LineWidth',1.5)
...
subplot(2,1,2)
 plot(time,func_x_i2_j2,'b-',time,fun_k_c_2,'r--',time,fun_fu_k_c_2,'k--','LineWidth',1.5)
...
figure()
plot(time,func_u_1_1_2,'b-',time,func_v_1_1_2,'r--','linewidth',1.5)
xlabel('Time(Sec)','Interpreter','latex')
...
set(gca,'FontSize',10)
figure()
plot(time,func_u_1_2_2,'b-',time,func_v_1_2_2,'r--','LineWidth',1.5)%,time,func_u_1_2_2,'r--'
xlabel('Time(Sec)','Interpreter','latex') 
